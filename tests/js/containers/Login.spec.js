...
describe('Login View Tests (Container):', () => {
    ...
    describe('Store Integration:', () => {
        context('State map:', (done) => {
            ...
            it('props', () => {
                expect(wrapper.node.selector.props.isAuthenticating).to.equal(isAuthenticating(state));
                expect(wrapper.node.selector.props.statusText).to.equal(state.common.statusText);
            });
